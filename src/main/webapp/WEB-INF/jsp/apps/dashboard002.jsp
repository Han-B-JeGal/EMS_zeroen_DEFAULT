					...
					<div id="container" class="dashboard dashboard2 clear">
						<div class="box_wrap box1 clear">
							<div class="cont bd0">
								...
								<span class="data">${dashboardService.get(0) }</span>
							</div>
							<div class="cont">
								...
								<span class="data">${dashboardService.get(1) }</span>
							</div>
							<div class="cont">
								...
								<span class="data">${dashboardService.get(2) }</span>
							</div>
							<div class="cont">
								...
								<span class="data">${dashboardService.get(3) }</span>
							</div>
							<div class="cont">
								...
								<span class="data">${dashboardService.get(4) }</span>
							</div>
						</div>
